...
//     public delegate void fmi2CallbackLogger(
...
//     delegate fmi2Status fmi2GetRealDelegate(
//         fmi2Component c,
...
//     delegate fmi2Status fmi2SetRealDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         fmi2Real[] value
...
//     delegate fmi2Status fmi2GetIntegerDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         fmi2Integer[] value
...
//     delegate fmi2Status fmi2SetIntegerDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         fmi2Integer[] value
...
//     delegate fmi2Status fmi2GetBooleanDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         fmi2Boolean[] value
...
//     delegate fmi2Status fmi2SetBooleanDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         fmi2Boolean[] value
...
//     delegate fmi2Status fmi2GetStringDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         IntPtr[] value
...
//     delegate fmi2Status fmi2SetStringDelegate(
//         fmi2Component c,
//         fmi2ValueReference[] vr,
//         size_t nvr,
//         [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] fmi2String[] value
//     );
...
//             fmi2EnterInitializationMode = getFunc<fmi2EnterInitializationModeDelegate>(
//                 dll,
//                 "fmi2EnterInitializationMode"
//             );
//             fmi2ExitInitializationMode = getFunc<fmi2ExitInitializationModeDelegate>(
//                 dll,
...
//             var resourceLocation = new Uri(unzipdir + "/resources/").AbsoluteUri;

//             component = fmi2Instantiate(
//                 instanceName,
//                 (int)fmi2Type.fmi2CoSimulation,
//                 guid,
//                 resourceLocation,
//                 callbacks,
//                 fmi2False,
//                 loggingOn ? fmi2True : fmi2False
//             );
//         }
...
//         )
//         {
//             var status = fmi2SetupExperiment(
//                 component,
...
//         TDelegate getFunc<TDelegate>(IntPtr dll, string fname)
